...
header2 = "COMPUTER SCIENCE      2025  SEMESTER ONE   ***GROUP 6***"
...
while counter <= numberOfCourseUnits:
    ...
    CreditHours = float(input(f"Enter the credit hours for {course_unit} from (1 - 4): "))

    GradePointValue = (score/100) * 5
    GradePoint = round(CreditHours * GradePointValue, 2)
    ...
    print(f"The Grade Point Course (GPC) in {course_unit} is {GradePoint}, congs")
...
print(f"Thank you {sur_name} {first_name} for collaborating with group 6")
